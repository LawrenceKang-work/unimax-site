...
module.exports = {
    zh: {
      ...
      "foot.guides":"指南","guide.1":"什么是东革阿里独立包饮品？","guide.2":"东革阿里饮品 vs 胶囊","guide.3":"如何甄选东革阿里供应商","guide.4":"转售用批发补剂","guide.5":"自创品牌还是做分销商？","guide.6":"能量饮料是清真（halal）的吗？","guide.7":"浓缩活力饮和能量饮料有什么区别？","guide.8":"能量饮料的「植物基」到底指什么？","guide.9":"面向欧洲分销商",
      "cat.1t":"产品本身","cat.1d":"UNI MAX 是什么，摆上货架是什么样。","cat.2t":"配方成分","cat.2d":"里面有什么，依据是什么。","cat.3t":"功效与用法","cat.3d":"对终端顾客有什么用，怎么喝。","cat.4t":"谁在买","cat.4d":"为谁而做，他们怎么说。",
      "cn.eyebrow":"你在和谁打交道","cn.h2":"我们的业务网络","cn.lead":"四家公司，一条链路。下面每一环都写明背后的主体，以及它负责什么。","cn.1d":"拥有 UNI MAX 品牌与配方。产品规格、包装与品牌使用规范由这里制定。","cn.2d":"在其马来西亚的认证工厂完成生产与灌装。上方五项认证均登记在这家工厂名下。","cn.3d":"负责马来西亚以外市场的出口安排与分销授权。","cn.4d":"欧洲市场的询价、报价、订单与落地支持，统一由这里对接。","cn.tag":"你的对接方","cn.note":"你只需对接一个窗口，它背后的每一环都已在上方写明。",
      ...
      "nav.wholesale":"批发与分销","order.wholesaleLink":"查看完整批发与分销资讯 →","order.consumerLead":"只是想自己买一份？","order.consumerLink":"通过 WhatsApp 下单 →",
      "cta.order":"成为合作伙伴","cta.orderNow":"立即订购","cta.explore":"了解配方","cta.finalBtn":"成为 UNI MAX 合作伙伴",
      ...
      "cta.h2a":"准备好与","cta.h2b":"UNI MAX 一起成长了吗？","cta.p":"加入我们在欧洲不断扩大的批发与分销伙伴网络。","cta.sub":"通过 WhatsApp 联系我们——我们当天回复",
      ...
      "order.p1sub":"小型保健店、健身房、诊所与补剂专卖店","order.p2sub":"电商卖家、大型健身房与多门店零售商","order.p3sub":"国家级或区域合作伙伴","order.best":"最受欢迎","order.freeship":"免运费","order.cta":"成为合作伙伴","order.p3save":"更省","order.poa":"价格待定","order.p1price":"12–24 盒","order.p2price":"50–100 盒","order.p3price":"300+ 盒",
    ...
    ms: {
      ...
      "foot.guides":"Panduan","guide.1":"Apa itu minuman sachet Tongkat Ali?","guide.2":"Minuman Tongkat Ali vs kapsul","guide.3":"Memilih pembekal Tongkat Ali","guide.4":"Suplemen borong untuk dijual semula","guide.5":"Mulakan perniagaan atau jadi pengedar?","guide.6":"Adakah minuman tenaga halal?","guide.7":"Shot tenaga berbanding minuman tenaga: apakah bezanya?","guide.8":"Apakah yang menjadikan minuman tenaga 'berasaskan tumbuhan'?","guide.9":"Untuk pengedar di Eropah",
      "cat.1t":"Produk itu sendiri","cat.1d":"Apa itu UNI MAX, dan rupanya di atas rak.","cat.2t":"Formula","cat.2d":"Apa yang ada di dalamnya, dan bukti di sebaliknya.","cat.3t":"Manfaat & cara ambil","cat.3d":"Apa yang diberikannya kepada pengguna akhir, dan cara mereka mengambilnya.","cat.4t":"Siapa yang membeli","cat.4d":"Untuk siapa ia dibina, dan apa kata mereka.",
      "cn.eyebrow":"Dengan siapa anda berurusan","cn.h2":"Rangkaian Perniagaan Kami","cn.lead":"Empat syarikat, satu rangkaian. Setiap pautan di bawah menamakan entiti di sebaliknya dan apa yang menjadi tanggungjawabnya.","cn.1d":"Memiliki jenama dan formula UNI MAX. Spesifikasi produk, pembungkusan dan peraturan penggunaan jenama ditetapkan di sini.","cn.2d":"Pengeluaran dan pengisian dijalankan di kemudahan bersijilnya di Malaysia. Kelima-lima pensijilan di atas didaftarkan atas nama kemudahan ini.","cn.3d":"Menguruskan pengaturan eksport dan hak pengedaran bagi pasaran di luar Malaysia.","cn.4d":"Pertanyaan, sebut harga, pesanan dan sokongan di lapangan untuk Eropah semuanya melalui meja ini.","cn.tag":"hubungan anda","cn.note":"Anda berurusan dengan satu meja sahaja. Setiap pautan di sebaliknya dinamakan sepenuhnya di atas.",
      ...
      "nav.wholesale":"Borong & Pengedaran","order.wholesaleLink":"Lihat maklumat borong & pengedaran penuh →","order.consumerLead":"Hanya mahu beli untuk diri sendiri?","order.consumerLink":"Pesan melalui WhatsApp →",
      "cta.order":"Jadi Rakan Kongsi","cta.orderNow":"Pesan Sekarang","cta.explore":"Terokai formula","cta.finalBtn":"Jadi Rakan Kongsi UNI MAX",
      ...
      "cta.h2a":"Bersedia untuk berkembang bersama","cta.h2b":"UNI MAX?","cta.p":"Sertai rangkaian rakan borong dan pengedar kami yang semakin berkembang di seluruh Eropah.","cta.sub":"Hubungi kami melalui WhatsApp — kami membalas pada hari yang sama",
      ...
      "order.p1sub":"Kedai kesihatan kecil, gim, klinik & kedai suplemen","order.p2sub":"Penjual e-dagang, gim besar & peruncit berbilang cawangan","order.p3sub":"Rakan kongsi peringkat negara atau serantau","order.best":"PALING POPULAR","order.freeship":"PENGHANTARAN PERCUMA","order.cta":"Jadi Rakan Kongsi","order.p3save":"Lebih jimat","order.poa":"Harga atas permintaan","order.p1price":"12–24 kotak","order.p2price":"50–100 kotak","order.p3price":"300+ kotak",
    ...
    pl: {
      ...
      "foot.guides":"Poradniki","guide.1":"Czym jest napój Tongkat Ali w saszetce?","guide.2":"Napój Tongkat Ali a kapsułki","guide.3":"Jak wybrać dostawcę Tongkat Ali","guide.4":"Suplementy hurtowe do odsprzedaży","guide.5":"Własna firma czy dystrybucja?","guide.6":"Czy napoje energetyczne są halal?","guide.7":"Shot energetyczny a napój energetyczny: różnica","guide.8":"Co sprawia, że napój energetyczny jest 'roślinny'?","guide.9":"Dla dystrybutorów w Europie",
      "cat.1t":"Sam produkt","cat.1d":"Czym jest UNI MAX i jak wygląda na półce.","cat.2t":"Formuła","cat.2d":"Co jest w środku i co za tym stoi.","cat.3t":"Działanie i stosowanie","cat.3d":"Co daje klientowi końcowemu i jak się go przyjmuje.","cat.4t":"Kto to kupuje","cat.4d":"Dla kogo powstał i co mówią ci ludzie.",
      "cn.eyebrow":"Z kim masz do czynienia","cn.h2":"Nasza sieć biznesowa","cn.lead":"Cztery spółki, jeden łańcuch. Przy każdym ogniwie poniżej wskazujemy podmiot i zakres jego odpowiedzialności.","cn.1d":"Właściciel marki i receptury UNI MAX. Tutaj ustalane są specyfikacja produktu, opakowanie i zasady używania marki.","cn.2d":"Produkcja i konfekcjonowanie odbywają się w jej certyfikowanym zakładzie w Malezji. Wszystkie pięć certyfikatów powyżej wystawiono na ten zakład.","cn.3d":"Odpowiada za organizację eksportu i prawa dystrybucyjne na rynkach poza Malezją.","cn.4d":"Zapytania, wyceny, zamówienia i wsparcie na miejscu dla Europy prowadzi to biuro.","cn.tag":"twój kontakt","cn.note":"Rozmawiasz z jednym biurem. Cały łańcuch za nim wskazaliśmy powyżej z nazwy.",
      ...
      "nav.wholesale":"Hurt i dystrybucja","order.wholesaleLink":"Zobacz pełne informacje o hurcie i dystrybucji →","order.consumerLead":"Chcesz kupić tylko dla siebie?","order.consumerLink":"Zamów przez WhatsApp →",
      "cta.order":"Zostań partnerem","cta.orderNow":"Zamów teraz","cta.explore":"Odkryj formułę","cta.finalBtn":"Zostań partnerem UNI MAX",
      ...
      "cta.h2a":"Gotowy na rozwój z","cta.h2b":"UNI MAX?","cta.p":"Dołącz do naszej rosnącej sieci partnerów hurtowych i dystrybutorów w całej Europie.","cta.sub":"Napisz do nas na WhatsApp — odpowiadamy tego samego dnia",
      ...
      "order.p1sub":"Małe sklepy ze zdrową żywnością, siłownie, kliniki, sklepy z suplementami","order.p2sub":"Sprzedawcy e-commerce, większe siłownie, sieci wielooddziałowe","order.p3sub":"Partnerzy krajowi lub regionalni","order.best":"NAJPOPULARNIEJSZE","order.freeship":"BEZPŁATNA DOSTAWA","order.cta":"Zostań partnerem","order.p3save":"Oszczędzaj więcej","order.poa":"Cena na zapytanie","order.p1price":"12–24 opakowań","order.p2price":"50–100 opakowań","order.p3price":"300+ opakowań",
    ...
    nl: {
      ...
      "foot.guides":"Gidsen","guide.1":"Wat is een Tongkat Ali sachetdrank?","guide.2":"Tongkat Ali drank vs capsules","guide.3":"Een Tongkat Ali-leverancier kiezen","guide.4":"Groothandelssupplementen voor wederverkoop","guide.5":"Eigen bedrijf of distributeur worden?","guide.6":"Zijn energiedranken halal?","guide.7":"Energy shot versus energiedrank: het verschil","guide.8":"Wat maakt een energiedrank 'plantaardig'?","guide.9":"Voor distributeurs in Europa",
      "cat.1t":"Het product","cat.1d":"Wat UNI MAX is en hoe het in het schap staat.","cat.2t":"De formule","cat.2d":"Wat erin zit en waar dat op gebaseerd is.","cat.3t":"Werking & gebruik","cat.3d":"Wat het de eindklant oplevert en hoe die het inneemt.","cat.4t":"Wie het koopt","cat.4d":"Voor wie het gemaakt is en wat zij ervan zeggen.",
      "cn.eyebrow":"Met wie je zakendoet","cn.h2":"Ons zakelijke netwerk","cn.lead":"Vier bedrijven, één keten. Bij elke schakel hieronder staat welke entiteit erachter zit en waarvoor die verantwoordelijk is.","cn.1d":"Eigenaar van het merk en de formule van UNI MAX. Productspecificatie, verpakking en merkgebruiksregels worden hier vastgelegd.","cn.2d":"Productie en afvulling gebeuren in de gecertificeerde faciliteit in Maleisië. De vijf certificeringen hierboven staan op naam van deze faciliteit.","cn.3d":"Verzorgt exportafspraken en distributierechten voor markten buiten Maleisië.","cn.4d":"Aanvragen, offertes, orders en ondersteuning ter plaatse voor Europa lopen allemaal via deze desk.","cn.tag":"jouw aanspreekpunt","cn.note":"Je hebt met één desk te maken. De hele keten daarachter staat hierboven met naam en toenaam.",
      ...
      "nav.wholesale":"Groothandel & distributie","order.wholesaleLink":"Bekijk alle groothandel- en distributie-informatie →","order.consumerLead":"Wil je gewoon voor jezelf kopen?","order.consumerLink":"Bestel via WhatsApp →",
      "cta.order":"Word partner","cta.orderNow":"Nu bestellen","cta.explore":"Ontdek de formule","cta.finalBtn":"Word UNI MAX-partner",
      ...
      "cta.h2a":"Klaar om te groeien met","cta.h2b":"UNI MAX?","cta.p":"Sluit je aan bij ons groeiende netwerk van groothandelspartners en distributeurs in heel Europa.","cta.sub":"Stuur ons een bericht via WhatsApp — we reageren dezelfde dag",
    ...
    de: {
      ...
      "foot.guides":"Ratgeber","guide.1":"Was ist ein Tongkat-Ali-Sachet-Drink?","guide.2":"Tongkat-Ali-Drink vs. Kapseln","guide.3":"Einen Tongkat-Ali-Lieferanten wählen","guide.4":"Großhandelspräparate zum Wiederverkauf","guide.5":"Eigenes Geschäft oder Vertriebspartner?","guide.6":"Sind Energydrinks halal?","guide.7":"Energy-Shot vs. Energydrink: der Unterschied","guide.8":"Was macht einen Energy-Drink 'pflanzenbasiert'?","guide.9":"Für Vertriebspartner in Europa",
      "cat.1t":"Das Produkt","cat.1d":"Was UNI MAX ist und wie es im Regal aussieht.","cat.2t":"Die Formel","cat.2d":"Was drin ist und worauf das beruht.","cat.3t":"Wirkung & Anwendung","cat.3d":"Was es dem Endkunden bringt und wie er es einnimmt.","cat.4t":"Wer es kauft","cat.4d":"Für wen es gemacht ist und was diese Menschen sagen.",
      "cn.eyebrow":"Mit wem Sie es zu tun haben","cn.h2":"Unser Unternehmensnetzwerk","cn.lead":"Vier Unternehmen, eine Kette. Bei jedem Glied steht, welche Gesellschaft dahinter steht und wofür sie verantwortlich ist.","cn.1d":"Inhaberin der Marke und Rezeptur von UNI MAX. Produktspezifikation, Verpackung und Regeln zur Markennutzung werden hier festgelegt.","cn.2d":"Herstellung und Abfüllung erfolgen in ihrer zertifizierten Anlage in Malaysia. Die fünf Zertifikate oben lauten auf diese Anlage.","cn.3d":"Verantwortet Exportabwicklung und Vertriebsrechte für Märkte außerhalb Malaysias.","cn.4d":"Anfragen, Angebote, Bestellungen und Unterstützung vor Ort für Europa laufen allesamt über diesen Desk.","cn.tag":"Ihr Ansprechpartner","cn.note":"Sie haben es mit einem Desk zu tun. Die gesamte Kette dahinter ist oben namentlich benannt.",
      ...
      "nav.wholesale":"Großhandel & Vertrieb","order.wholesaleLink":"Vollständige Großhandels- und Vertriebsinformationen ansehen →","order.consumerLead":"Möchten Sie nur für sich selbst kaufen?","order.consumerLink":"Über WhatsApp bestellen →",
      "cta.order":"Partner werden","cta.orderNow":"Jetzt bestellen","cta.explore":"Formel entdecken","cta.finalBtn":"UNI MAX Partner werden",
      ...
      "cta.h2a":"Bereit, zu wachsen mit","cta.h2b":"UNI MAX?","cta.p":"Werden Sie Teil unseres wachsenden Netzwerks aus Großhandelspartnern und Vertriebspartnern in ganz Europa.","cta.sub":"Schreiben Sie uns auf WhatsApp — wir antworten noch am selben Tag",
      ...
      "order.p1sub":"Kleine Wellness-Shops, Fitnessstudios, Kliniken, Supplement-Läden","order.p2sub":"E-Commerce-Händler, größere Fitnessstudios, Filialisten","order.p3sub":"Partner auf Landes- oder regionaler Ebene","order.best":"BELIEBTESTE","order.freeship":"KOSTENLOSER VERSAND","order.cta":"Partner werden","order.p3save":"Mehr sparen","order.poa":"Preis auf Anfrage","order.p1price":"12–24 Boxen","order.p2price":"50–100 Boxen","order.p3price":"300+ Boxen",
